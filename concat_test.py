...
sorted_result.to_csv('test_concat6.csv',index=False)
 """
df1 = pandas.read_csv("bbc_data1.csv")
df2 = pandas.read_csv("bbc_data2.csv")
df3 = pandas.read_csv("bbc_data3.csv")
df4 = pandas.read_csv("bbc_data4.csv")
df5 = pandas.read_csv("bbc_data5.csv")
df6 = pandas.read_csv("bbc_data6.csv")

result = pandas.concat([df1,df2,df3,df4,df5,df6]).drop_duplicates().reset_index(drop=True)
result['pubDate'] = pandas.to_datetime(result.pubDate)
result.sort_values(by='pubDate')
sorted_result = result.sort_values(by=['pubDate'], ascending=False)
sorted_result.to_csv('bbc_data.csv',index=False)
